<template>
  <div class="grid">
    ...
    <div class="panel">
      ...
      <div v-else class="small">Сначала отсканируйте QR клиента.</div>
      <div class="field-group">
        <input v-model.number="amount" type="number" :placeholder="t('placeholders.amount')" :disabled="!card" />
