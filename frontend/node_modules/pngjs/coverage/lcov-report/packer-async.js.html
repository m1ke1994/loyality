...
<head>
    <title>Code coverage report for packer-async.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> packer-async.js</h1>
        <div class='clearfix'>
...
let PackerAsync = (module.exports = function (opt) {
  Stream.call(this);
&nbsp;
  let options = opt || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
&nbsp;
