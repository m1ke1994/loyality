...
<head>
    <title>Code coverage report for parser-sync.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> parser-sync.js</h1>
        <div class='clearfix'>
...
module.exports = function (buffer, options) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!hasSyncZlib) {
...
&nbsp;
  ...
  inflateData = null;
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!inflatedData || !inflatedData.length) {
<span class="cstat-no" title="statement not covered" >    throw new Error("bad png - invalid inflate data response");</span>
  }
&nbsp;
